...
public class CommentsTest extends TestBase2 {
    ...
    public void emptyCommentsClass() throws InterruptedException {
        ...
        Assert.assertEquals(formsPage.getCommentInputClass(), PropertyLoader.loadProperty("inputClassValid2"));
    }

    @Test(priority = 2)
    public void emptyCommentsHighlight() throws InterruptedException {
        Assert.assertEquals(formsPage.getCommentInputBorderColor(), PropertyLoader.loadProperty("border_color_gray"));
    }

    @Test(priority = 3)
    public void oneCharinComments() throws InterruptedException {
        formsPage.fillComments1();
        formsPage.clickOnSubmit();
        Assert.assertEquals(formsPage.commentsCounterGetValue(), "1999");
    }

    @Test(priority = 4)
    public void oneCharCommentsClass() throws InterruptedException {
        Assert.assertEquals(formsPage.getCommentInputClass(), PropertyLoader.loadProperty("inputClassValid"));
    }
    ...
    public void thousandCharinComments() throws InterruptedException {
        Thread.sleep(3000);
        formsPage.fillComments1000();
        Thread.sleep(1000);
        formsPage.clickOnSubmit();
        Assert.assertEquals(formsPage.commentsCounterGetValue(), "1000");
    }
    ...
    public void twothousandCharinComments() throws InterruptedException {
        Thread.sleep(3000);
        formsPage.fillComments2000();
        Thread.sleep(1000);
        formsPage.clickOnSubmit();
        Assert.assertEquals(formsPage.commentsCounterGetValue(), "0");
    }
    ...
    public void twothousandoneCharCommentsText() throws InterruptedException {
        Assert.assertEquals(formsPage.commentsGetValue(), PropertyLoader.loadProperty("comment2000"));
    }
