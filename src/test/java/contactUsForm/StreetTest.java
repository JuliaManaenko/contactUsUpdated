...
public class StreetTest extends TestBase2 {
    ...
    public void strEmptyValueClass() throws InterruptedException {
        ...
        Thread.sleep(1000);
        Assert.assertEquals(formsPage.getStreetInputClass(), PropertyLoader.loadProperty("inputClassValid2"));
    }

    @Test(priority = 2)
    public void streEmptyValueHighlight() throws InterruptedException {
        Assert.assertEquals(formsPage.getStreetInputBorderColor(), PropertyLoader.loadProperty("border_color_gray"));
    }
    ...
    public void strCorrectCharClass(String street) throws InterruptedException {
        ...
        waitForJSandJQueryToLoad();
        Thread.sleep(1000);
        Assert.assertEquals(formsPage.getStreetInputClass(), PropertyLoader.loadProperty("inputClassValid"));
    }
