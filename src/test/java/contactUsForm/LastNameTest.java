...
public class LastNameTest extends TestBase2 {
    ...
    public void lEmptyValueClass() throws InterruptedException {
        ...
        Thread.sleep(1000);
        Assert.assertEquals(formsPage.getLastNameInputClass(), PropertyLoader.loadProperty("inputClassError"));
    }

    @Test(priority = 2)
    public void lEmptyValueHighlight() throws InterruptedException {
        Thread.sleep(1000);
        Assert.assertEquals(formsPage.getLastNameInputBorderColor(), PropertyLoader.loadProperty("border_color_red"));
    }
    ...
    public void lCorrectCharClass(String lName) throws InterruptedException {
        ...
        waitForJSandJQueryToLoad();
        Thread.sleep(1000);
        Assert.assertEquals(formsPage.getLastNameInputClass(), PropertyLoader.loadProperty("inputClassValid"));
    }
    ...
    public void lCorrectCharHighlight(String lName) throws InterruptedException {
        ...
        waitForJSandJQueryToLoad();
        Thread.sleep(1000);
        Assert.assertEquals(formsPage.getLastNameInputBorderColor(), PropertyLoader.loadProperty("border_color_gray"));
    }
