 ...
 */
public class TradeInWidgetTitle {
    ...
    @Test(dataProvider = "text", dataProviderClass = DataProviderSet1.class)
    @Parameters({"browserName"})
    public void checkTradeInTitle(String text) throws InterruptedException {
