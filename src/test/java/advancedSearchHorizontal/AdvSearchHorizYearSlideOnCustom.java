...
/**
 * Created by Julia on 04.04.2017.
 */
public class AdvSearchHorizYearSlideOnCustom extends AdvSearchHorizStyleOnCustom {

    private static final Logger LOG = LogFactory.getLogger(AdvSearchHorizYearSlideOnCustom.class);
