 ...
 */
public class AdvSearchTestBaseInv {
    ...
    /*run browser, add home page in MAP2, initialize dmsHome and home pages, open dws link*/
    @BeforeClass
    ...
    /*delete Inventory page in MAP2, close browser*/
